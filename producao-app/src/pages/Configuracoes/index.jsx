...
const SECOES = [
  ...
  { caminho: '/configuracoes/subestacoes',              icone: '🏭', titulo: 'Subestações',           descricao: 'Cadastro de subestações (Limpeza de Subestação)',          superAdmin: true },
  ...
  { caminho: '/configuracoes/atividades-preco-fixa',    icone: '🏷️', titulo: 'Preço Fixa por Vigência', descricao: 'Preço por período para atividades FIXA (contrato de Faixa)', superAdmin: true },
  ...
  { caminho: '/configuracoes/atualizacoes',              icone: '📋', titulo: 'Atualizações',           descricao: 'Histórico de versões publicadas e o que mudou',            soDanilo: true },
]
